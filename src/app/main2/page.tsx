...
export default function Main2() {
  ...
  return (
    <div
      className="container mx-auto home-page-wrapper"
    ...
    >
      ...
      {/* 배경 이미지 섹션 */}
      <section className="stack-bg" style={{ height: '800px', width: '100%', zIndex: 0 }}>
        <Image
          src={Background}
      ...
      <section className="main2-bg-wrap">
        <div className="text-logo">
          ...
          <p>
            건축 설계자, 건물 소유자, 시설 관리자를 대상으로, 건물 내 연돌현상을
            <br />
            평가하고 그에 따른 해결방안을 제시하는 웹 기반 시스템
          </p>
          <a
            href="#"
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="w-full md:w-1/2 stack-intro-left">
            ...
            <div className="intro-logo">
              <p>건물 연돌현상 분석 솔루션</p>S <span>T</span> A C K
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 stack-intro-right">
            ...
            <p>
              ...
              <br />
              최신 기술과 전문가의 노하우를 결합하여 건물 소유자, 설계자, 시설 관리자에게 최적의
              결과를 제공합니다.
              <br />
              연돌현상으로 인한 에너지 손실, 실내 공기질 저하, 소음 문제를 효과적으로 해결하여
              건물의 가치를 높이고 사용자 만족도를 향상시킵니다.
              <br />
              온라인 평가 도구부터 전문적인 엔지니어링 서비스까지, STACK과 함께 더 효율적이고 쾌적한
              건물 환경을 만들어보세요.
              <br />
              국내 최고의 연돌현상 전문가와 함께 건물의 문제를 진단하고 맞춤형 솔루션을
              제공받으세요.
            </p>
        ...
        <div className="services-container">
          ...
          <div className="service-grid">
            ...
            <div className="service-item">
              ...
              <h3>ABOUT STACK</h3>
              <p>
                STACK은 건물 연돌현상 문제 해결을 위한 통합 솔루션 플랫폼입니다. 전문적인 기술과
                경험을 바탕으로 효과적인 연돌현상 개선 방법을 제시합니다. 저희와 함께 건물의 에너지
                효율과 쾌적한 실내 환경을 달성하세요.
              </p>
            ...
            <div className="service-item">
              ...
              <h3>연돌현상이란</h3>
              <p>
                연돌현상은 건물 내 온도 차이로 인해 발생하는 공기의 수직 이동 현상입니다. 이로 인해
                에너지 손실, 불쾌한 냄새, 소음 등 다양한 문제가 발생할 수 있습니다. 건물의 설계
                단계에서부터 적절한 대응이 필요한 중요한 현상입니다.
              </p>
            ...
            <div className="service-item">
              ...
              <h3>엔지니어링 실적</h3>
              <p>
                STACK은 다양한 건물 유형에서 연돌현상 문제를 성공적으로 해결했습니다. 고층 아파트,
                상업 건물, 공공 시설 등 다양한 프로젝트 포트폴리오를 보유하고 있습니다. 실제 사례를
                통해 STACK의 전문성과 효과를 확인하세요.
              </p>
              <a
                href="#"
            ...
            <div className="service-item">
              ...
              <h3>연돌현상 평가</h3>
              <p>
                건물의 연돌현상 위험도를 온라인으로 신속하게 평가할 수 있습니다. 간단한 건물 정보
                입력만으로 전문적인 연돌현상 평가 결과를 받아보세요. 평가 결과를 바탕으로 맞춤형
                해결책을 제안해 드립니다.
              </p>
              <a
                href="#"
            ...
            <div className="service-item">
              ...
              <h3>엔지니어링 서비스</h3>
              <p>
                STACK의 전문 엔지니어가 연돌현상 해결을 위한 맞춤형 서비스를 제공합니다. 설계
                검토부터 시뮬레이션, 현장 측정, 개선안 제시까지 종합적인 서비스를 경험하세요.
            ...
            <div className="service-item">
              ...
              <h3>서비스 요청</h3>
              <p>
                STACK의 다양한 서비스에 대한 상담 및 견적을 요청하실 수 있습니다. 프로젝트의 규모와
                요구사항에 맞는 맞춤형 서비스 계획을 제안해 드립니다. 간편한 양식 작성을 통해
                신속하게 전문가와 상담을 시작하세요.
              </p>
      ...
      <section className="contact-section">
        <div className="contact-container">
          <div className="text-center">
            ...
            <h2 className="contact-title">엔지니어링 서비스 요청 및 문의하기</h2>
            <p className="contact-description">
              STACK의 전문 엔지니어가 연돌현상 해결을 위한 맞춤형 서비스를 제공합니다.
              <br />
              프로젝트의 규모와 요구사항에 맞는 서비스 계획을 제안해 드립니다.
              <br />
              지금 바로 문의하셔서 건물 환경을 개선하세요.
            </p>
