        ...
        <table className="service-comparison-table w-full text-center border-collapse">
          ...
          <thead>
            <tr>
              ...
              <th className="title basic" style={{ fontSize: '1.2rem' }}>
                <strong>BASIC</strong>연돌현상 예측 평가
              </th>
              <th className="title plus" style={{ fontSize: '1.2rem' }}>
                <strong>PLUS</strong>연돌현상 예측 평가
              </th>
              <th className="title advanced" style={{ fontSize: '1.2rem' }}>
                <strong>ADVANCED</strong>연돌현상 설계검토
              </th>
              <th className="title professional" style={{ fontSize: '1.2rem' }}>
                <strong>PROFESSIONAL</strong>연돌현상 시뮬레이션
              </th>
            </tr>
            <tr>
              <th className="title2"></th>
              <th className="title2">무료</th>
              <th className="title2">00만원부터</th>
              <th className="title2">00만원부터</th>
              <th className="title2">00만원부터</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 건물 내 영향도 평가
              </td>
              <td>
                <span className="ok"></span> 건물 내 영향도 평가
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 주요층 압력차 데이터
              </td>
              <td>
                <span className="ok"></span> 주요층 압력차 데이터
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 문제 예상 발생률
              </td>
              <td>
                <span className="ok"></span> 문제 예상 발생률
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 개선방향 목록
              </td>
              <td>
                <span className="ok"></span> 개선방향 목록
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 전문가 검토 의견 및 요약서
              </td>
              <td>
                <span className="ok"></span> 전문가 검토 의견 및 요약서
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 문제 저감 및 냉난방부하 저감효과
              </td>
              <td>
                <span className="ok"></span> 문제 저감 및 냉난방부하 저감효과
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 개선안 리스트 및 상세 데이터
              </td>
              <td>
                <span className="ok"></span> 개선안 리스트 및 상세 데이터
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 건축/설비 도면 검토를 통한 개선안
              </td>
              <td>
                <span className="ok"></span> 건축/설비 도면 검토를 통한 개선안
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 기밀화 구획도
              </td>
              <td>
                <span className="ok"></span> 기밀화 구획도
              </td>
            ...
            <tr>
              ...
              <td>
                <span className="ok"></span> 층별/존별 공기유동 및 압력차 분석
              </td>
            </tr>
            <tr>
              ...
              <td>
                <span className="ok"></span> 개선전략 케이스별 저감효과 비교분석
              </td>
            </tr>
            <tr>
              ...
              <td>
                <span className="ok"></span> 개선전략 케이스별 우선 순위 평가
              </td>
            </tr>
