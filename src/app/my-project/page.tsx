        ...
        <>
          ...
          {activeTab === 'analysis' && (
            <div className='cppe-explain' style={{marginBottom: '0px'}}>
              <h2><span className='num'>1</span> 분석 결과 요약</h2>
              {/* 1. 분석 결과 요약 */}
              <section>
              ...
              <h2 className='mt-8'><span className='num'>2</span> 연돌현상 예측결과</h2>
              {/* 2. 연돌현상 예측결과 */}
              <section>
                <div className='flex flex-col md:flex-row gap-8'>
                  <div className='w-full md:w-2/2 left'>
              ...
              <h2 className='mt-8'><span className='num'>3</span> 문제/하자 예상 결과</h2>
              {/* 3. 문제/하자 예상 결과 */}
              <section>
                <div className='flex flex-col md:flex-row gap-8'>
                  <div className='w-full md:w-2/2 left'>
                        ...
                        <div className='flex flex-col gap-4 col-span-2'>
                          ...
                          <div className='icon-list'>
                            ...
                            <div className='text-wrap'>
                              ...
                              <div className='desc'>화재 및 피난 화재 및 피난 화재 및 피난 화재 및 피난 화재 및 피난 화재 및 피난</div>
                            </div>
                          </div>
              ...
              <h2 className='mt-8'><span className='num'>4</span> 압력차 검토 데이터</h2>
              {/* 4. 압력차 검토 데이터 */}
              <section>
                <div className='flex flex-col md:flex-row gap-8'>
                  <div className='w-full md:w-2/2 left'>
          ...
          {activeTab === 'solution' && (
            <div className='cppe-explain' style={{marginBottom: '0px'}}>
              <h2><span className='num'>1</span> 해결방안 개요</h2>
              ...
              <div className='flex items-center gap-5 mt-8'>
                <h2><span className='num'>2</span> 개선안 리스트</h2>
                ...
                <div className='flex flex-col md:flex-row gap-8'>
                  <div className='w-full md:w-2/2 left'>
                    ...
                    <div className="box-wrap-bg mt-8">
                      <div className='box-title' style={{marginBottom: '0.5rem'}}>특수방안</div>
                      200m 규모의 건물에서의 적정 평균 압력은 00Pa 이며, 
                      최대 압력차가 000Pa을 넘어가면 문제 발생 가능성이 증가합니다. 
                      해당 건물은 적정 최대 압력차인 000Pa에 대해 149% 
                      수준의 압력차가 발생할 것입니다.
              ...
              <div className='flex items-center gap-5 mt-8'>
                <h2><span className='num'>3</span> 연돌현상 설계검토 및 시뮬레이션</h2>
                <div className='title-sub mb-3'>
                  <Image src={iconDecrease} alt='절감 아이콘' width={14} height={14} />
                  <strong>53%</strong> 절감
                </div>
