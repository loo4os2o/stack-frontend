    ...
    <div className="container mx-auto px-4 pt-16 pb-24">
      ...
      <section className='cppe-explain'>
        <div className='flex flex-col md:flex-row gap-8'>
          ...
          <div className='w-full md:w-3/5 right center'>
      ...
      >
        <div>
          ...
          <input type="text" className="w-full px-3 py-2 border rounded mb-4" placeholder="이름을 입력하세요" />
          ...
          <input type="text" className="w-full px-3 py-2 border rounded" placeholder="연락처를 입력하세요" />
        </div>
      </Modal>
